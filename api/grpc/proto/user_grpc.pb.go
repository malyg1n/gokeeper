...
type AuthClient interface {
	RegisterUser(ctx context.Context, in *AuthUserRequest, opts ...grpc.CallOption) (*AuthUserResponse, error)
...
func (c *authClient) RegisterUser(ctx context.Context, in *AuthUserRequest, opts ...grpc.CallOption) (*AuthUserResponse, error) {
...
func (c *authClient) AuthUser(ctx context.Context, in *AuthUserRequest, opts ...grpc.CallOption) (*AuthUserResponse, error) {
	out := new(AuthUserResponse)
	err := c.cc.Invoke(ctx, "/user.Auth/AuthUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	RegisterUser(context.Context, *AuthUserRequest) (*AuthUserResponse, error)
...
func (UnimplementedAuthServer) RegisterUser(context.Context, *AuthUserRequest) (*AuthUserResponse, error) {
...
func _Auth_RegisterUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).RegisterUser(ctx, req.(*AuthUserRequest))
	}
